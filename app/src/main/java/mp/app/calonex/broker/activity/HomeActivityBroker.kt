...
import mp.app.calonex.broker.fragment.CxMessagingFragmentBroker
import mp.app.calonex.broker.fragment.HomeFragmentBroker
import mp.app.calonex.broker.fragment.PaymentHistoryFragmentBroker
import mp.app.calonex.broker.fragment.PropertyFragmentBroker
...
class HomeActivityBroker : CxBaseActivity() {

    val BackgroundIntentServiceAction = "android.intent.action.CUSTOME_ACTION_1"

    private var fragmentHome: Fragment = HomeFragmentBroker() // done-dashboard
    private var fragmentProfile: Fragment = ProfileFragmentAgent() // done-profile
    private var fragmentMsg: Fragment = CxMessagingFragmentBroker() // done-message
    private var fragmentProperty: Fragment = PropertyFragmentBroker() // done-properties
    private var fragmentHistory: Fragment = PaymentHistoryFragmentBroker() // done-payments
        ...
        fm.beginTransaction().add(R.id.container, fragmentHistory, "5").hide(fragmentHistory)
            ...
            */
                ...
                R.id.navigation_dashboard -> {
                    fragmentHome = HomeFragmentBroker()
                ...
                R.id.navigation_property -> {
                    fragmentProperty = PropertyFragmentBroker()
                ...
                R.id.navigation_payment -> {
                    fragmentHistory = PaymentHistoryFragmentBroker()
                ...
                R.id.navigation_message -> {
                    fragmentMsg = CxMessagingFragmentBroker()
                ...
                R.id.navigation_profile -> {
                    fragmentProfile = ProfileFragmentAgent()

...
import mp.app.calonex.landlord.dashboard.BarChartFragment


class BrokerChartAdapter(showGarphActivity: Context, supportFragmentManager: FragmentManager) : FragmentPagerAdapter(supportFragmentManager) {

    // This determines the fragment for each tab
    override fun getItem(position: Int): Fragment {
        return when (position) {
            0 -> {
                BrokerBarChartFragment.newInstance()
            }
//            1 -> {

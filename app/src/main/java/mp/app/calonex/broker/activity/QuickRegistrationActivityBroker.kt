...
import kotlinx.android.synthetic.main.activity_quick_registration_agent.*
...
import mp.app.calonex.landlord.activity.SignupDoneActivity
...
class QuickRegistrationActivityBroker : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_quick_registration_agent)
        ...
        txt_signin.setOnClickListener {
          //  startActivity(Intent(this@QuickRegistrationActivityBroker, LoginScreen::class.java))
    ...
    fun validData() {
        ...
        registrationPayload.ssn =RSA.encrypt(edit_ut_ssn.text.toString().trim())
        ...
        registrationPayload.userRoleName = "CX-Broker"
    ...
    fun registerUploadApi(bitmapUpload: Bitmap, keyValue: String, idValue: String) {
        if (NetworkConnection.isNetworkConnected(applicationContext)) {
            ...
            var file: File? = bitmapToFile(this@QuickRegistrationActivityBroker, bitmapUpload, keyValue)
            ...
            apiCallUploadSign.subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread()).subscribe({
                    ...
                    if (count == documentPayloadList.size) {
                        pb_ut_confirm!!.visibility = View.GONE
                        window.clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE)
//                        startActivity(Intent(this@QuickRegistrationActivityBroker, SignupDoneActivity::class.java))
//                        finish()

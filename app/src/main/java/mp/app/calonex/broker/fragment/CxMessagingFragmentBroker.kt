...
import kotlinx.android.synthetic.main.fragment_cx_messaging_agent.*
...
class CxMessagingFragmentBroker : Fragment() {
    ...
    var messageListNotification = ArrayList<AppNotifications>()
    ...
    private var messageList = ArrayList<CxMessageListData>()
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_cx_messaging_agent, container, false)
    ...
    private fun initComponents(viewRoot: View) {
        ...
        layoutCxNotify = viewRoot.findViewById(R.id.layout_cx_notify)
        txtCxNotify = viewRoot.findViewById(R.id.txt_cx_notify)
        val searchTextViewId: Int = searchMessage!!.context.resources
                    ...
                    if (!response.data?.isEmpty()!!) {
                        ...
                        for (i in 0..appNotifications.size - 1) {
                            ...
                            if (appNotifications[i].activityType == "1" && appNotifications[i].agentRequest == "true") {
                                ...
                                messageListNotification.add(appNotifications[i])
                            }
                        }
                    }

...
import mp.app.calonex.landlord.activity.LoginScreen.Companion.registrationPayload
import mp.app.calonex.registration.response.ValidateEmailResponse
import java.util.regex.Matcher
import java.util.regex.Pattern

class LoginCredentialScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_login_credential_screen)
        initComponent()
        actionComponent()
    }
    ...
    fun actionComponent(){
        ...
        btnCredSignin!!.setOnClickListener {

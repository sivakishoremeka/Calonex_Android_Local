...
class UserContactDetailScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_user_contact_detail_screen)
        initComponent()
        actionComponent()
    }
    ...
    override fun onResume() {
        ...
        if(Kotpref.isRegisterConfirm){
            ...
            //editRegBusinessName!!.setText(registrationPayload3.businessName)
            ...
            editRegPhnNmbr!!.setText(PhoneNumberUtils.formatNumber(registrationPayload3.phoneNumber,"US"))
            ...
            btnRegNxt!!.setText(getString(R.string.done))
    ...
    fun validComponent() {
        ...
        //regDrivingLicence=editRegDrivingLicence!!.text.toString().trim()
        ...
        //registrationPayload3.businessName=regBusinessName

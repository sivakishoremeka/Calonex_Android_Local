...
class NewUserDocumentScreenAgent : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_new_user_document_screen_agent)
    ...
    private fun validBitmap() {
        ...
        if (Kotpref.isRegisterConfirm) {
            ...
            Util.navigationNext(this, NewUserConfirmDetailScreenAgent::class.java)
        }
    }

...
class LandlordSignUploadScreen : AppCompatActivity() {
...
*/
                ...
                if (data.data != null) {
                    ...
                    if (data.clipData != null) {
                        ...
                        for (i in 0 until mClipData!!.itemCount) {
                            ...
                            val uri = item.uri
                            AddNewPropertyFirstScreen.mArrayUri.add(uri)
                            val cursor =
                        ...
                        Log.v(
                            "LOG_TAG",
                            "Selected Images" + AddNewPropertyFirstScreen.mArrayUri.size
                        )
                    }
                }
            } else {
    ...
    override fun onBackPressed() {
        super.onBackPressed()
        Util.navigationBack(this@LandlordSignUploadScreen)
    }
}
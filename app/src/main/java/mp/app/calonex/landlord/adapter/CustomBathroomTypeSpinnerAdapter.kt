...
class CustomBathroomTypeSpinnerAdapter(val context: Context, var listItemsTxt: List<BathroomType>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = listItemsTxt[position].bathroomType
        return view
    }

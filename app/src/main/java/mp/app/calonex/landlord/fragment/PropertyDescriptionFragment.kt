...
class PropertyDescriptionFragment  : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val rootView =  inflater.inflate(R.layout.fragment_property_description, container, false)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        var docValue:String?=""
        for(item in PropertyListAdapter.listPropertyImages)
        {

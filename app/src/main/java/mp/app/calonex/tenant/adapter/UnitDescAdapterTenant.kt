...
import mp.app.calonex.tenant.activity.TenantPropertyDetailViewActivity
import java.text.SimpleDateFormat
import java.util.*
import kotlin.collections.ArrayList
import kotlin.collections.HashMap

class UnitDescAdapterTenant(
    var context: Context,
    val pbUnit: ProgressBar,
    var activity: FragmentActivity?,
    val unitList: ArrayList<UnitDetailsPD>
) : RecyclerView.Adapter<UnitDescAdapterTenant.ViewHolder>(), Filterable {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        try {
            ...
            for (item in TenantPropertyDetailViewActivity.propertyFileResponseLocal) {
                if (item.uploadFileType.equals(context.getString(R.string.key_img_unit))) {
        ...
        if (TenantPropertyDetailViewActivity.propertyDetailResponseLocal.propertyStatus.equals("4")) {
        ...
        holder.txtTenantLease.setOnClickListener {
            ...
            if (holder.txtTenantLease.text.equals(context.getString(R.string.add_tenants)) || holder.txtTenantLease.text.equals(
                ...
                intent.putExtra("LANDLORD ID", TenantPropertyDetailViewActivity.propertyDetailResponseLocal.landlordId)
                intent.putExtra("PROPERTY ID", TenantPropertyDetailViewActivity.propertyDetailResponseLocal.propertyId)
        ...
        holder.imgUnitLease.setOnClickListener {
            ...
            intent.putExtra(
                ...
                TenantPropertyDetailViewActivity.propertyDetailResponseLocal.address + ", " + TenantPropertyDetailViewActivity.propertyDetailResponseLocal.city + ", " + TenantPropertyDetailViewActivity.propertyDetailResponseLocal.state +
                        ", " + TenantPropertyDetailViewActivity.propertyDetailResponseLocal.zipCode
            )
            intent.putExtra(
                context.getString(R.string.intent_property_id),
                TenantPropertyDetailViewActivity.propertyDetailResponseLocal.propertyId.toString()
            )
            intent.putExtra(
                context.getString(R.string.intent_unit_id),
                listUnit.get(position).propertyUnitID
        ...
        try {
            ...
            var featureListPD: ArrayList<UnitFeaturePD> = TenantPropertyDetailViewActivity.propertyDetailResponseLocal!!.unitFeatureDTO
            var utilityListPD: ArrayList<UnitUtilityPD> = TenantPropertyDetailViewActivity.propertyDetailResponseLocal!!.unitUtilitiesDTO

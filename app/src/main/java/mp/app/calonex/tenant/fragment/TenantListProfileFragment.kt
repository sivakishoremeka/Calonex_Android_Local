...
import mp.app.calonex.tenant.fragment.ProfileTenantFragment.Companion.userDetailResponse
import java.io.IOException


class TenantListProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView =
            inflater.inflate(R.layout.fragment_tenant_list_user_profile, container, false)
        try {
            getUserInfo()
            init(rootView)
    ...
    private fun init(view: View) {
        ...
        back_image = view.findViewById(R.id.tenant_list_profile_back)
    ...
    private fun componentAction() {
        ...
        layoutUserDocs!!.setOnClickListener {
            //navigationNext(activity!!, PersonalInformationScreen::class.java)

...
import mp.app.calonex.agent.fragment.ProfileFragmentAgent.Companion.subcriptionPlanList
...
class SelectSubcriptionPlanNew : CxBaseActivity2() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_select_subcription_plan_new)
        initComponent()
        actionComponent()
        startHandler()
    }
    ...
    fun initComponent(){
        ...
        registrationPayload.userId = Kotpref.userId
        ...
        spinnerUnits?.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                if (position> 0){
                    ...
                    vpSubscripePlan!!.adapter=SubscriptionPlanAdapterNew(applicationContext,isRegister!!,pbMsdPlan!!,this@SelectSubcriptionPlanNew,planList!!)
                }
            }

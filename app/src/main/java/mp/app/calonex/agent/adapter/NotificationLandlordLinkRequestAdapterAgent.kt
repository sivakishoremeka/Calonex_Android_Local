...
class NotificationLandlordLinkRequestAdapterAgent(
    ...
    RecyclerView.Adapter<NotificationLandlordLinkRequestAdapterAgent.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Log.e("WWW1", Gson().toJson(mNotificationLinkRequest))

        holder.address.text = mNotificationLinkRequest.propAddress + " " + mNotificationLinkRequest.city + " " + mNotificationLinkRequest.state + " " + mNotificationLinkRequest.zipCode
                holder.txtRequestedByName.text = mNotificationLinkRequest.landlordName
        holder.txtRequestedById.text = mNotificationLinkRequest.units
        ...
        holder.button_accept.setOnClickListener {
            ...
            actionProperty("APPROVED", objectList.propertyId.toString())
            //Log.e("WWW", objectList.propertyId.toString())
        }
        ...
        holder.button_reject.setOnClickListener {
            ...
            notificationId = notifyList[holder.adapterPosition].notificationId.toString()
            linkRequestId = objectList.agentLicenseNo.toString()
            actionProperty("REJECT", objectList.propertyId.toString())
        }
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var v = LayoutInflater.from(context).inflate(R.layout.item_link_landlord_request_agent, parent, false)
        return ViewHolder(v)
    }
    ...
    fun actionProperty(act:String, propertyid: String) {
        ...
        credential.notificationId = notificationId.toLong()
        credential.propertyId = propertyid
        //credential.userCatalogID = mNotificationLinkRequest.userId.toString()
        credential.userCatalogID = Kotpref.userId
        credential.action = act //"REJECTED"
        ...
        val apiCall: Observable<LinkRequestActionResponse> =
            propertyLinkAction.propertyActionBA(credential) //Test API Key

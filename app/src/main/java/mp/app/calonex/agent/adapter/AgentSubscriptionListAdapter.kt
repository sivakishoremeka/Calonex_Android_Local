...
class AgentSubscriptionListAdapter(
    var context: Context,
    var activity: FragmentActivity?,
    var list: ArrayList<AgentSubscriptionList>
) : RecyclerView.Adapter<AgentSubscriptionListAdapter.ViewHolder>(),
    Filterable {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.status.text = "$" + listPayment[position].agentCommission
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var v = LayoutInflater.from(context).inflate(R.layout.item_agent_subscription, parent, false)
